@if ($paginator->hasPages())
	<div class="pagination-container align-center justify-content-center m-3">
		<ul class="pagination pagination-warning justify-content-center" id="borderedTab" role="tablist">
...
@if (count($machines)) {{ $machines->onEachSide(1)->links('mypage.pagination1') }} @endif